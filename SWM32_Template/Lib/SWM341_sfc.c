/******************************************************************************************************************************************
* 文件名称: SWM341_sfc.c
* 功能说明:	SWM341单片机的 SFC(Serial Flash Controller)模块驱动库
...
* 输    入: SFC_InitStructure * initStruct	SFC 初始化配置值
* 输    出: 无
* 注意事项: 无
******************************************************************************************************************************************/
...
* 函数名称:	SFC_Write()
* 功能说明:	SPI Flash数据写入
* 输    入: uint32_t addr		数据要写入到 Flash中的地址，字对齐
...
* 函数名称:	SFC_Read()
* 功能说明:	SPI Flash数据读取
* 输    入: uint32_t addr		要读取的数据在 Flash中的地址，字对齐
