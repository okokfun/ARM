...
* 函数名称:	LCD_Init()
* 功能说明:	LCD初始化
* 输    入: LCD_TypeDef * LCDx	指定要被设置的 LCD，有效值包括LCD
...
* 功能说明:	LCD层初始化
* 输    入: LCD_TypeDef * LCDx	指定要被设置的 LCD，有效值包括LCD
*			uint32_t layerx		要初始化的 LCD层，取值LCD_LAYER_1、LCD_LAYER_2
...
* 功能说明:	LCD层位置设定
* 输    入: LCD_TypeDef * LCDx	指定要被设置的 LCD，有效值包括LCD
*			uint32_t layerx		要设置的 LCD层，取值LCD_LAYER_1、LCD_LAYER_2
...
/******************************************************************************************************************************************
* 函数名称: LCD_INTEn()
* 功能说明:	LCD 中断使能，完成指定长度的数据传输时触发中断
* 输    入: LCD_TypeDef * LCDx	指定要被设置的 LCD，有效值包括LCD
* 输    出: 无
* 注意事项: 无
******************************************************************************************************************************************/
...
/******************************************************************************************************************************************
* 函数名称: LCD_INTDis()
* 功能说明:	LCD 中断禁止，完成指定长度的数据传输时不触发中断
* 输    入: LCD_TypeDef * LCDx	指定要被设置的 LCD，有效值包括LCD
* 输    出: 无
* 注意事项: 无
******************************************************************************************************************************************/
