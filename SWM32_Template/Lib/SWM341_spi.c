...
void SPI_Init(SPI_TypeDef * SPIx, SPI_InitStructure * initStruct) {
    ...
    SPI_Close(SPIx);	//一些关键寄存器只能在 SPI关闭时设置
...
* 输    入: SPI_TypeDef * SPIx		指定要被设置的 SPI，有效值包括SPI0、SPI1、SPI1
*			uint32_t				要写入的数据
* 输    出: 无
* 注意事项: 无
******************************************************************************************************************************************/
...
/******************************************************************************************************************************************
* 函数名称:	SPI_IsRXEmpty()
* 功能说明:	接收 FIFO是否空，如果不空则可以继续SPI_Read()
* 输    入: SPI_TypeDef * SPIx		指定要被设置的 SPI，有效值包括SPI0、SPI1
...
/******************************************************************************************************************************************
* 函数名称:	SPI_IsTXFull()
* 功能说明:	发送 FIFO是否满，如果不满则可以继续SPI_Write()
* 输    入: SPI_TypeDef * SPIx		指定要被设置的 SPI，有效值包括SPI0、SPI1
...
* 功能说明:	发送 FIFO是否空
* 输    入: SPI_TypeDef * SPIx		指定要被设置的 SPI，有效值包括SPI0、SPI1
* 输    出: uint32_t				1 发送 FIFO 空    0 发送 FIFO非空
* 注意事项: 无
******************************************************************************************************************************************/
...
* 输    入: SPI_TypeDef * SPIx		指定要被设置的 SPI，有效值包括SPI0、SPI1
*			I2S_InitStructure * initStruct	包含 I2S相关设定值的结构体
* 输    出: 无
* 注意事项: 无
******************************************************************************************************************************************/
void I2S_Init(SPI_TypeDef * SPIx, I2S_InitStructure * initStruct) {
    ...
    I2S_Close(SPIx);	//一些关键寄存器只能在 SPI关闭时设置
