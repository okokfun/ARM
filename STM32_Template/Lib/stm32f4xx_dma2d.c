/**
 ...
 ===============================================================================
    [..]
        ...
        3. 调用 DMA2D_Start() 以启用 DMA2D 控制器。
